...
,
	...
	prereqs: class_features: [ "Cast Arcane" ]
	conditional: true
	arcane: true
	groups: [ "Combat" ]
	tags: [ "pathfinder" ]
...
,
	...
	prereqs: feats: [ "Armor Proficiency, Medium" ]
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "44c1"
,
...
,
	...
	prereqs: feats: [ "Armor Proficiency, Light" ]
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "f286"
,
...
,
	...
	prereqs:
		or: [ class_features: [ "Cast Arcane" ], class_features: [ "Cast Divine" ] ]
		feats: [ "Spell Focus" ]
...
,
	...
	prereqs: or: [ class_features: [ "Cast Arcane" ], class_features: [ "Cast Divine" ] ]
	conditional: true
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "b11c"
...
,
	...
	prereqs: class_features: [ "Ki Pool" ]
	conditional: true
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "35cd"
,
	...
	prereqs: class_features: [ "Lay On Hands" ]
	conditional: true
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "e8a1"
...
,
	...
	prereqs: class_features: [ "Bardic Performance" ]
	conditional: true
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "e2e3"
...
,
	...
	prereqs: feats: [ "Point-Blank Shot" ]
...
,
	...
	prereqs: feats: [ "Spell Penetration" ]
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "1cad"
,
...
,
	...
	prereqs: feats: [ "Combat Expertise" ]
	groups: [ "Combat" ]
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "47bb"
...
,
	...
	prereqs: feats: [ "Lightning Reflexes" ]
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "eeb0"
,
...
,
	...
	prereqs:
		or: [ feats: [ "Catch Off-Guard" ], feats: [ "Throw Anything" ] ]
		base_attack_bonus: 8
...
,
	...
	prereqs: or: [ skills: "Craft *": 5, skills: "Profession *": 5 ]
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "50d3"
,
...
,
	...
	prereqs: feats: [ "Improved Unarmed Strike" ]
	groups: [ "Combat" ]
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "d58c"
...
,
	...
	prereqs: feats: [ "Improved Bull Rush", "Mounted Combat" ]
	groups: [ "Combat" ]
	tags: [ "pathfinder" ]
	type: "feat"
	_id: "3b95"
...
,
	...
	attack: (attacks, weapon, char_feat) ->
		...
		if ~char_feat?.multi?.indexOf(weapon.name)
			for i, base_attack  of attacks.base
