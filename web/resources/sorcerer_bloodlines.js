...
this.bloodline_powers = TAFFY([
  {
      ...
      0: {
        weapons: {
          "Acidic Ray": {
            ...
            dam: function(level) {
              return "1d6" + common.pos(Math.round((level + 1) / 2));
            },
            note: function() {
              var times;
              times = 3 + (calc_ability_modifier(chardata.abilities["Cha"]));
              if (times > 0) {
                return times + " times/day";
              } else {
                return null;
              }
            },
    ...
    levels: {
      9: {
        dr: function(drs) {
          drs["base"] = (drs["base"] ? drs["base"] : 0) + 5;
          return drs;
        }
      }
    },
        ...
        weapons: {
          "Claws": {
            ...
            dam: function() {
              var dam, size;
              dam = "1d3/1d3";
              size = sizes.indexOf(races.first({
                name: chardata.race
              }).size);
              if (size > 3) dam = "1d4/1d4";
              return dam;
            },
        ...
        weapons: {
          "Claws": {
            note: function() {
              ...
              if (rounds > 0) {
                return "+1d6 fire " + rounds + " rounds/day";
              } else {
                return "";
              }
            }
    ...
    levels: {
      2: {
        dr: function(dr) {
          dr["elec"] = (dr["elec"] ? dr["elec"] : 0) + 5;
          return dr;
        },
        save: function(save) {
          save["pois"] = (save["pois"] ? save["pois"] : 0) + 2;
          return save;
        },
        vals: ["5", "2"]
      },
      8: {
        ...
        save: function(save) {
          save["pois"] = (save["pois"] ? save["pois"] : 0) + 4;
          return save;
        },
        vals: ["10", "4"]
      }
    ...
    levels: {
      2: {
        dr: function(dr) {
          ...
          return dr["cold"] = (dr["cold"] ? dr["cold"] : 0) + 5;
        },
        vals: ["5"]
      },
      8: {
        dr: function(dr) {
          dr["acid"] = (dr["acid"] ? dr["acid"] : 0) + 10;
          return dr["cold"] = (dr["cold"] ? dr["cold"] : 0) + 10;
        },
        vals: ["10"]
      }
    },
    ...
    levels: {
      8: {
        spells_known: function(spells_known) {
          return spells_known.push(1);
        }
      },
      12: {
        spells_known: function(spells_known) {
          return spells_known.push(2);
        }
      },
      16: {
        spells_known: function(spells_known) {
          return spells_known.push(3);
        }
      }
    },
    _id: "a5c4"
      ...
      8: {
        ...
        weapons: {
          "Breath Weapon": {
            ...
            dam: function() {
              return (chardata.classes["Sorcerer"].level + 1) + "d6";
            },
            note: function() {
              return draconic_types.first({
    ...
    levels: {
      19: {
        dr: function(dr) {
          if (draconic_energy_type) return dr[draconic_energy_type] = -1;
        },
        save: function(save) {
          save["para"] = "imm";
          return save["sleep"] = "imm";
        }
      }
    },
    _id: "cfd77"
    ...
    levels: {
      2: {
        dr: function(dr) {
          if (chardata.bloodline_energy_type) {
            return dr[chardata.bloodline_energy_type] = (dr[chardata.bloodline_energy_type] ? dr[chardata.bloodline_energy_type] : 0) + 10;
          }
        }
      }
    },
