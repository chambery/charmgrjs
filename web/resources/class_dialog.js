function show_class_dialog(level_diff, ability_increase) {
	var html = "<table>" + (chardata.xp > 0 ? "" : "<tr><td colspan=4>Select a starting class:<td></tr>") + "<tr><td colspan='2'>Available Levels:</td><td id='level_diff' style='width: 40%;text-align: left;'>" + level_diff + "</td><td></td></tr></table><table>";
	var classnames = [];
	...
	show_dialog("Classes", html, true, "char_classes = chardata.classes.keys; switch_content(1, chardata)", { width: 270 });
}
