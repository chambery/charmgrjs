...
exports["damage"] = (test) ->
	...
	test.equal chardata.damage(chardata.weapons(weapon_name: "Glaive").first()), "1d10", "Glaive damage should be 1d10 for no mods"
	chardata.abilities["Str"] = 14
	test.equal chardata.damage(chardata.weapons(weapon_name: "Glaive").first()), "1d10+3", "Glaive damage should be 1d10+3 for Strength 14 (2)"
	test.equal chardata.damage(chardata.weapons(weapon_name: "Longbow, composite").first()), "1d8+2", "Longbow, composite damage should be 1d8 for Strength 14 (2)"
	test.equal chardata.damage(chardata.weapons(weapon_name: "Longbow").first()), "1d8", "Longbow damage should be 1d8 for Strength 14 (2)"
	chardata.abilities["Str"] = 6
	test.equal chardata.damage(chardata.weapons(weapon_name: "Longbow, composite").first()), "1d8-2", "Longbow, composite damage should be 1d8-2 for Strength 6 (-2)"
	test.equal chardata.damage(chardata.weapons(weapon_name: "Longbow").first()), "1d8-2", "Longbow damage should be 1d8-2 for Strength 6 (-2)"
	test.equal chardata.damage(chardata.weapons(weapon_name: "Glaive").first()), "1d10-2", "Glaive damage should be 1d10 for Strength 6 (-2)"
