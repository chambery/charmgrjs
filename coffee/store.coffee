...
lod = (char_name) ->
  if char_name
    ...
    if chardata.options and chardata.options.owner
      ...
      sync_logs()
  load_static_data()
sav = (data, local_name, remote_name) ->
