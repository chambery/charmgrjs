edit_weapons.update_data = (select_id, data_name, id_name) ->
...
edit_weapons.add_data = (data_name, id_name) ->
...
edit_weapons.build_data_part = (data_name, id_name) ->
	char_data_html = ""
...
edit_weapons.populate_data_part = (data_name, id_name) ->
...
edit_weapons.update_override = (item_index, data_name, id_name) ->
	for i of window[id_name + "_edit_data"]
...
edit_weapons.c_s = (part_id, name, items, onchange_action, onblur_action, addl_data, include_empty, selected_value) ->
