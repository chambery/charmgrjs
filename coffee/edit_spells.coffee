edit_spells = ->
recalc_spells_page = (level, spell_name, classname) ->
...
edit_spells.build_spells_page = ->
  ...
  for classname of chardata.classes
    spellcaster_count++  if spellcasters.indexOf(classname) > -1 and natural_spellcasters.indexOf(classname) == -1
  $("#content").html ""
  for classname of chardata.classes
    ...
    if clazz.custom and clazz.custom.spells and clazz.custom.spells.after_spells
      for i of clazz.custom.spells.after_spells
