...
var bloodline_powers = new TAFFY([{
    ...
    levels: {
        14: {
            script: function () {
                return (chardata.classes['Sorcerer'].level + 1) + 10;
            }
        }
    },
    _id: "3a89"
    ...
    name: "New Arcana",
    detail: "You can add any one spell from the sorcerer/wizard spell list to your list of spells known. This spell must be of a level that you are capable of casting. You can also add one additional spell at 13th level and 17th level.",
    level: {
        8: {
            spells_known: 1
        },
    ...
    name: "Fated",
    detail: "Starting at 3rd level, you gain a +1 luck bonus on all of your saving throws and to your AC during surprise rounds (see Chapter 8) and when you are otherwise unaware of an attack. At 7th level and every four levels thereafter, this bonus increases by +1, to a maximum of +5 at 19th level.",
    levels: {
        2: {},
        6: {},
        10: {},
    ...
    detail: "At 3rd level, you gain resist 5 against your energy type and a +1 natural armor bonus. At 9th level, your energy resistance increases to 10 and natural armor bonus increases to +2. At 15th level, your natural armor bonus increases to +4.",
    levels: {},
    _id: "bb33d"
}, {
    name: "Breath Weapon",
    ...
    name: "Wings",
    detail: "At 15th level, leathery dragon wings grow from your back as a standard action, giving you a fly speed of 60 feet with average maneuverability. You can dismiss the wings as a free action.",
    levels: {},
    _id: "d0cd3"
}, {
    name: "Power of Wyrms",
    detail: "At 20th level, your draconic heritage becomes manifest. You gain immunity to paralysis, sleep, and damage of your energy type. You also gain blindsense 60 feet.",
    levels: {},
    _id: "cfd77"
}, {
    name: "Elemental Ray",
    ...
    detail: "At 3rd level, you gain energy resistance 10 against your energy type. At 9th level, your energy resistance increases to 20.",
    levels: {},
    _id: "c3265"
}, {
