classes = new TAFFY([{
    ...
    custom: {
		...
		feats: {
				1: {
					script: "bonus.count +=  1; if(chardata.weapon_style == 'Archery') { bonus.feats['Far Shot'] = true; bonus.feats['Point-Blank Shot'] = true; bonus.feats['Precise Shot'] = true; bonus.feats['Rapid Shot']; } else { bonus.feats['Double Slice'] = true; bonus.feats['Improved Shield Bash'] = true; bonus.feats['Quick Draw'] = true; bonus.feats['Two-Weapon Fighting'] = true; }"
				},
				5: {
