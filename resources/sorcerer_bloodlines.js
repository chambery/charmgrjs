var bloodline_powers, sorcerer_bloodlines;
        ...
        weapons: [
          {
            ...
            dam: function() {
              return "1d6" + pos(Math.round((chardata.classes["Sorcerer"].level + 1) / 2));
            },
            note: function() {
              var times;
      ...
      19: {
        dr: function(dr) {
          if (draconic_energy_type) {
            return dr[draconic_energy_type] = -1;
          }
        },
        save: function(save) {
          save["para"] = "imm";
